...
```ruby
include ':react-native-neon'
project(':react-native-neon').projectDir = new File(rootProject.projectDir, '../node_modules/react-native-neon/android/app')
```
2. Add the compile line to the dependencies in `android/app/build.gradle`:
```ruby
dependencies {
    ---------------------
    compile project(':react-native-neon')
}
```
...
### Import NeonAndroid
```ruby
import NeonAndroid from 'react-native-neon';
```
### React methods
